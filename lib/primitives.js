...
class Angle extends ObjGraf {
    ...
    normalize() {
        this.rayBegin.value = Calc.angleNormalize(this.rayBegin.value);
        this.rayEnd.value = Calc.angleNormalize(this.rayEnd.value);
    }
    ...
    get isDVA_PI() {
        return Calc.round(this.value) == Calc.round(DVA_PI);
    }

    get isZero() {
        return Calc.round(this.value) == 0;
    }
