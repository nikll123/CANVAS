...
class Arc extends BasicShape {
    ...
    draft(ctx, lineWidth, colorStroke = DRAFT_COLOR, fillColor) {
        _render(ctx, lineWidth, colorStroke, fillColor, draft = true)
    }
...
class CircleCombo extends Circle {
    ...
    draft(ctx, lineWidth, colorStroke = DRAFT_COLOR, fillColor) {
        this._render(ctx, lineWidth, colorStroke, fillColor, true)
    }
