...
let c = new CircleCombo(200, 200, 100, [new Angle(0, DVA_PI)], 'crcl1');
let l1 = new Line(50,50,50,300, 'l1');
[angle1, angle2] = Calc.crossCircleLine(c, l1);
let l2 = new Line(150,50,150,300, 'l1');
[angle1, angle2] = Calc.crossCircleLine(c, l2);
