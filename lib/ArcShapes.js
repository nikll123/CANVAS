...
class Arc extends BasicShape {
    ...
    splitXY(ctx, x, y) {
        ...
        if (this.isPointInStroke(ctx, x, y)) {
            ...
            resArcs = [];
            resArcs.push(new Arc(this.x, this.y, this.radius, new Angle(this.begin, a), this.ccw));
            resArcs.push(new Arc(this.x, this.y, this.radius, new Angle(a, this.end), this.ccw));
        }
        return resArcs;
    }
    ...
    get isCircle() {
        return this.end - this.begin == DVA_PI;
    }
