...
class Triangle extends Poligon {
    ...
    isPointInPath(x, y) {
        return Calc.isPointInPathTriangle(x, y, this.points[0], this.points[1], this.points[2]);
    }
}
...
class Quadrangle extends Poligon {
    ...
    isPointInPath(x, y) {
        let r1 = Calc.isPointInPathTriangle(x, y, this.points[0], this.points[1], this.points[2]);
        let r2 = Calc.isPointInPathTriangle(x, y, this.points[0], this.points[2], this.points[3]);
        return r1 || r2;
    }
}
